...
export async function fetchLeibenTable() {
    ...
    foreach(team, async (t) => {
        await page.goto(`https://vereine.oefb.at/LeibenSv/Mannschaften/Saison-2024-25/${t}/Tabellen`, {
...
export async function fetchLeibenGamePlan() {
    ...
    await page.goto("https://vereine.oefb.at/LeibenSv/Mannschaften/Saison-2024-25/KM/Spiele", {
        waitUntil: "networkidle0",
    });
    ...
    const rawGames = await page.$$eval(".widget-list.spiele .widget-list_container", (containers) =>
        containers.map((node) => {
