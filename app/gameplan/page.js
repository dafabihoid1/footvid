...
import { NavigationMenuItem, NavigationMenuList, NavigationMenuTrigger } from "@radix-ui/react-navigation-menu";
...
export default function GamePlan_Page() {
    ...
    const mobileGames = allGames.filter(g => (g.team || "KM") === activeTeam);
